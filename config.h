...
// zoom = switch between master and slave

static Key keys[] = {
	/* type      modifier                 key        function        argument */
	{ KeyRelease, MODKEY|ShiftMask, XK_s, spawn, SHCMD("scrot -se 'mv $f /home/julius/Pictures/screenshots'") },
	...
	{ KeyPress, MODKEY,                       XK_f,	   zoom,           {0} },
	{ KeyPress, MODKEY,                       XK_d,      incnmaster,     {.i = -1 } },
	{ KeyPress, MODKEY,                       XK_s,      incnmaster,     {.i = +1 } },
	{ KeyPress, MODKEY,		        XK_q,      killclient,     {0} },
	{ KeyPress, MODKEY,                       XK_w,      setlayout,      {.v = &layouts[0]} },
	{ KeyPress, MODKEY,                       XK_e,      setlayout,      {.v = &layouts[1]} },
	{ KeyPress, MODKEY,                       XK_r,      setlayout,      {.v = &layouts[2]} },
	{ KeyPress, MODKEY|ShiftMask,             XK_r,  	   togglefloating, {0} },
	...
	{ KeyPress, MODKEY,                       XK_F5,     xrdb,           {.v = NULL } },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
